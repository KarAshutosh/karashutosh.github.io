...
3. Dynamic property access: Accessing object properties using bracket notation (`obj[key]`) with variable keys, rather than dot notation (`object.property`) with fixed keys.
